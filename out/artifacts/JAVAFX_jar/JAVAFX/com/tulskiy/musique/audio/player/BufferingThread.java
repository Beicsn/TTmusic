...
public class BufferingThread extends Actor implements Runnable {
	...
	public synchronized void open(Track track, boolean forced) {
		...
		if (track != null) {
			...
			buffer.addNextTrack(currentTrack, decoder.getAudioFormat(), -1,
					forced);
	...
	public void seek(long sample) {
		...
		if (decoder != null) {
			decoder.seekSample(currentTrack.getTrackData().getStartPosition()
					+ sample);
			currentByte = AudioMath.samplesToBytes(sample, decoder
